...
- [ ] **Step 1: 寫失敗測試** — `tests/eeprom_equiv_test.cpp`:
...
- [ ] **Step 1: 寫失敗測試** — `tests/it_pipeline_test.cpp` 檔尾新增:
...
- [ ] **Step 1: SPEC-004 勘誤**(頂部 revision 各加一行,日期 2026-07-16)
...
- [ ] **Step 2: SPEC-005 勘誤**(頂部 revision 加一行)
